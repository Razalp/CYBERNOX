      ...
      <div ref={refScrollContainer}>
        ...
        >
          <div className={styles.intro}>
            ...
            >
              <span className={styles.pill}>Instagram</span>
              <span className={styles.pill}>Gmail</span>
              <span className={styles.pill}>Linked in</span>
            </div>
            <div>
            <h1
  data-scroll
...
>
  ...
  <span className="clash-grotesk text-gradient text-6xl 2xl:text-8xl">
    Cyber<span className="text-orange-500">Nox</span>.
  </span>
</h1>
              ...
              >
                Your partner in innovative software development.
              </p>
            </div>
            <span
              data-scroll
            ...
            >
              <Link href="mailto:razalp0012300@gmail.com" passHref>
                <Button>
